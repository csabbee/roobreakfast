...
privileged aspect Food_Roo_Json {
    ...
    public static Food Food.fromJsonToFood(String json) {
        return new JSONDeserializer<Food>().use(null, Food.class).deserialize(json);
    }
    ...
    public static Collection<Food> Food.fromJsonArrayToFoods(String json) {
        return new JSONDeserializer<List<Food>>().use(null, ArrayList.class).use("values", Food.class).deserialize(json);
    }
